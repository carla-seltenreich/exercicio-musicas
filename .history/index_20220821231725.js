...
async function getMusicas() {
    let resultado = await client.query('select musicas.nome, musicas.artista, musicas.album, generos.descricao from musicas INNER JOIN generos ON musicas.genero_id = generos.id;');
